...
$mail->Body    = '<p>Dear participant,</p><br> 
		  <p>This e-mail is sent to remind you that the first stage of the experiment begins on '.$sintv1start.' and is accessible until '.$sintv1end.'. You can use your user name and password to log in to the experiment website:</p>
		  ...
		  <p>The second stage is accessible from '.$sintv2start.' to '.$sintv2end.'. Please make a note of these dates. Also please be aware that our e-mails may end up in your spam mail folder.</p><br>		   
		  <p>Best regards,</p>
		  <p>Emre Koc</p>
		  <br/>';

$mail->AltBody = 'Dear participant,\n \n 
		  This e-mail is sent to remind you that the first stage of the experiment begins on '.$sintv1start.' and is accessible until '.$sintv1end.'. You can use your user name and password to log in to the experiment website:\n
		  ...
		  The second stage is accessible from '.$sintv2start.' to '.$sintv2end.'. Please make a note of these dates. Also please be aware that our e-mails may end up in your spam mail folder.\n\n		   
		  Best regards, \n
		  Emre Koc \n';
...
echo "Message sent!";
$id=$rowt7['id'];
$queryu = "UPDATE tut_users SET stage1email=1 , updatetime1=NOW(), ip='".$_SERVER['REMOTE_ADDR']."' 
